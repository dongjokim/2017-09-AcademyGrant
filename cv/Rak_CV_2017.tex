...
\item Ji\v{r}\'i Kr\'al, Jyv\"askyl\"a University, ALICE experiment, PhD supervisor  (defense August 8th, 2014).
\item Beomsu Chang, Jyv\"askyl\"a University, ALICE experiment, PhD supervisor.
\item Jussi Viinikainen, supervised MSc, now PhD supervisor ALICE.
\item Esko Pohjoisaho, supervised MSc.
\item Marton Vargyas, PhD supervisor.
\item Jasper Parkkila, PhD supervisor.
\item Tomas Snellman, MSc supervisor (together with DongJo Kim), now PhD supervisor ALICE.
\end{enumerate}

\subsection{Summer students hosted by Jyv\"askyl\"a ALICE group:}
Timo Alho (2007),  Tiia Monto (2008), Mikko Kervinen (2009, 2010),  Jussi Viinikainen (2009, 2010), Subhashish Hazarica (2010), Tiina Naaranoja (2011), Esko Pohjoisaho (2011), Timo K\"arkk\"ainen (2012), Shawana Hameed (2012), Tomas Snellman (2013), Petja Paakkinen (2013), Juha Sulo (2014), Jaro Ruuskanen (2014), Henri H\"anninen (2015), Elias Barba Moral (2015), Jasper Parkkila (2016), Oskari Saarim\"aki (2017), Teemu Kovanen (2017).
...
\bibliography{bib-mypapers,bib-ALICE,bib-PHENIX}
